...
export class MCPServer {
                    ...
                    inputSchema: {
                        ...
                        properties: {
                            threadName: {
                                type: 'string',
                                description:
                                    'Name of the thread to create (1-100 characters)',
                            },
                            initialMessage: {
                                type: 'object',
                                properties: {
                                    title: {
                                        type: 'string',
                                        description:
                                            'The title of the initial message embed',
                                    },
                                    description: {
                                        type: 'string',
                                        description:
                                            'The description of the initial message embed',
                                    },
                                    fields: {
                                        type: 'array',
                                        items: {
                                ...
                                description:
                                    'Initial message to send when creating the thread',
                            },
                        },
                    ...
                    inputSchema: {
                        ...
                        properties: {
                            threadId: {
                                type: 'string',
                                description:
                                    'The ID of the thread to send message to',
                            },
                            title: {
                                type: 'string',
                                description: 'The title of the embed',
                            ...
                            waitForResponse: {
                                        ...
                                        items: {
                                            ...
                                            properties: {
                                                label: {
                                                    type: 'string',
                                                    description:
                                                        'Button display text (1-80 characters)',
                                                },
                                                value: {
                                                    type: 'string',
                                                    description:
                                ...
                                description:
                                    'Configuration for waiting for user response',
                            },
                        },
                        required: ['threadId'],
                    },
                    ...
                    inputSchema: {
                        ...
                        properties: {
                            filter: {
                                ...
                                description:
                                    'Filter threads by status (default: active)',
                            },
                        },
                        required: [],
                    },
                    ...
                    inputSchema: {
                        ...
                        properties: {
                            threadId: {
                                type: 'string',
                                description:
                                    'The ID of the thread to fetch messages from',
                            },
                            limit: {
                                type: 'number',
                                minimum: 1,
     ...
     * @returns 送信結果
     */
    private async sendTextChannelMessage(
        args: unknown
    ): Promise<CallToolResult> {
        try {
            // Zodバリデーション
    ...
    private async sendThreadMessage(args: unknown): Promise<CallToolResult> {
        try {
            ...
            const errorMessage =
                error instanceof Error ? error.message : String(error);
            throw new Error(
                `Failed to send message to thread: ${errorMessage}`
            );
        }
    }
